...
ActiveRecord::Schema.define(version: 20180224090210) do
  ...
  create_table "mini_blog_admin_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_mini_blog_admin_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_mini_blog_admin_users_on_reset_password_token", unique: true
  end
